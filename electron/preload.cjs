...
contextBridge.exposeInMainWorld('api', {
  ...
  secretsGetOpenAIApiKeyStatus: () => ipcRenderer.invoke('secrets:getOpenAIApiKeyStatus'),
  secretsSetOpenAIApiKey: (key) => ipcRenderer.invoke('secrets:setOpenAIApiKey', key),
  secretsClearOpenAIApiKey: () => ipcRenderer.invoke('secrets:clearOpenAIApiKey'),
